        ...
        >
            <div className="page_article sp">
                ...
                <div className="page_content">
                    ...
                    <p style={{ padding: '1rem', marginBottom: '0.5rem', backgroundColor: 'var(--gray-2)' }}>Der Quellcode der Webseite ist offen einsehbar. Die Quelle der Bilder und Audio-Dateien versucht Cookies zu setzen, abgesehen davon verwendet die Webseite keine Tracking-Tools.</p>
